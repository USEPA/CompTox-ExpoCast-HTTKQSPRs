...
CvT.data[,"Time"] <- signif(as.numeric(CvT.data[,"Time"]), 3)
...
fittable$k12 <- fittable$k12*24
fittable$k21 <- fittable$k21*24
fittable$kelim <- fittable$kelim*24
fittable$kgutabs <- fittable$kgutabs*24
fittable$Time.Units <- "days"
length(unique(fittable$DTXSID))
```
