...
series_res_set$Dose <- series_res_set$studies.dose_level_normalized_corrected # mg/kg
...
fittable$halflife <- fittable$halflife*24 # 1/day
...
write.csv(subset(fittable, !(DTXSID%in%fittable.noflat$DTXSID))[,
          c("DTXSID","CAS","Model","AIC","Species","method")], 
          row.names=FALSE,
