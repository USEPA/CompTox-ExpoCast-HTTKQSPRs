...
paste("The three chemicals with in vitro HTTK data and the shortest half-lives in rat were",
...
pharma <- read.csv("data/Chemical List ZINC15PHARMA-2024-09-09.csv")
