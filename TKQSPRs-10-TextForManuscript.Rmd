...
cat(paste0("In vitro measured Clint and fup data predict AUC with an RMSLE of 1.3, while the QSPR models range from RMSLE 1.1 to 1.4. The ensemble and OPERA QSPR model predictions have the lowest RMSLE of 1.1, but the ensemble QSPR provides predictions for more chemicals.\n"))

cat(paste0("From the AFE in Table 8, we see that there is a tendency to over-predict concentrations.")) 


cat(paste0("Most of the QSPR models and the in vitro measured Clint and fup data were unsuccessful for predicting t½, with RMSLE indicating errors between 1.5 and 1.8 (32- to 63-fold). The QSPR models that were trained specifically to t½, data (rather than in vitro measured Clint and fup) produce better predictions except when compared with the ensemble QSPR model.\n"))
```
...
cat(paste0("Across the full time course, both the in vitro measured data and ",
           ...
           "y-randomized predictions (RMSLE ",
           bench.table["CvT RMSLE",
             paste0("Y-Randomized (",
                    NUM.CHEMS,
                    ")")],
...
cat(paste0("Here, we have assumed that Fbio only depends on first-pass ",
           ...
           "bioavailabilit does not appear to be the primary driver of the ",
