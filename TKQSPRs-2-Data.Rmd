...
# Load the challenge chemicals
```{r load_challenge, eval=TRUE}
challenge <- read.csv("CvTdb/TestChemsDashboardInfo.csv")
write.table(challenge, 
          row.names=FALSE,
          sep="\t",
          file=paste("tables/SupTable",
          PREV.SUP.TABLES + 1,
          "-ChallengeChemicals.txt",
          sep=""))
```
...
write.table(subset(fittable, !(DTXSID%in%fittable.noflat$DTXSID))[,
          c("DTXSID","CAS","Model",
            #"AIC",
            "Species"#,
            #"method"
