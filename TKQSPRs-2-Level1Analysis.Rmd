...
for (this.col in seq(13,21,2)) CvT.chems.scale[,this.col] <- 
  ...
  heatmap.2(as.matrix(CvT.chems.scale[,4:(dim(CvT.chems.scale)[2])]),
    ...
    trace="none",
    col=mypalette)
  png(paste("figs/Fig-physchemandpredictors-heatmap-",
           output.prefix,
           ".tiff",sep=""),
...
print(FigLev1a)
ggsave(paste("figs/FigLev1a-Clint-obsvspred",output.prefix,".tiff",sep=""), 
...
ggsave(paste("figs/FigLev1a-Clint-obsvpred-facet-",output.prefix,".tiff",sep=""), 
       width=6, height=4, dpi=300)
```
...
print(FigLev1b) 
ggsave(paste("figs/FigLev1b-Clint-boxplot-wtable-",output.prefix,".tiff",sep=""), 
       width=6, height=4, dpi=300)
```
...
#  scale_y_continuous(limits=c(-3,5))+
  ...
  theme( text  = element_text(size=20),
         ...
         legend.title = element_text(size=8))
print(FigLev1d) 
ggsave(paste("figs/FigLev1d-fup-boxplot-wtable-",output.prefix,".tiff",sep=""), 
       width=6, height=4, dpi=300)
```
