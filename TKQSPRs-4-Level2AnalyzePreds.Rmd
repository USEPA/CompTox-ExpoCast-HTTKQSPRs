...
#Absolute Average Fold Error (AAFE) :  10^((1/n)*sum(abs(FE)))  ### use this. It's good to see fold error
  AAFE[["HTPBTK-InVitro-Measured"]] <- 10^(mean(meassub$AbsFE[
    meassub$QSPR=="HTPBTK-InVitro"],na.rm=TRUE))
  AAFE.early[["HTPBTK-InVitro-Measured"]] <- 10^(mean(meassub.early$AbsFE[
    meassub.early$QSPR=="HTPBTK-InVitro"],na.rm=TRUE))
  AAFE.late[["HTPBTK-InVitro-Measured"]] <- 10^(mean(meassub.late$AbsFE[
    meassub.late$QSPR=="HTPBTK-InVitro"],na.rm=TRUE))
#RMSLE sqrt(mean(log10(Xpred+1)-log10(Xobs+1))2)  ### use this
  RMSLE[["HTPBTK-InVitro-Measured"]] <- sqrt(mean((log10(meassub$Conc.pred[
    meassub$QSPR=="HTPBTK-InVitro"] /
    meassub$Conc.obs[meassub$QSPR=="HTPBTK-InVitro"]))^2,na.rm=TRUE))
  RMSLE.early[["HTPBTK-InVitro-Measured"]] <-
    sqrt(mean((log10(meassub.early$Conc.pred[
    meassub.early$QSPR=="HTPBTK-InVitro"] /
    meassub.early$Conc.obs[meassub.early$QSPR=="HTPBTK-InVitro"]))^2,na.rm=TRUE))
  RMSLE.late[["HTPBTK-InVitro-Measured"]] <-
    sqrt(mean((log10(meassub.late$Conc.pred[
    meassub.late$QSPR=="HTPBTK-InVitro"] /
    meassub.late$Conc.obs[meassub.late$QSPR=="HTPBTK-InVitro"]))^2,na.rm=TRUE))
  MRPE[["HTPBTK-InVitro-Measured"]] <- 
    median(subset(meassub,QSPR=="HTPBTK-InVitro")$RPE)
  MRPE.early[["HTPBTK-InVitro-Measured"]] <- 
    median(subset(meassub.early,QSPR=="HTPBTK-InVitro")$RPE)
  MRPE.late[["HTPBTK-InVitro-Measured"]] <- 
    median(subset(meassub.late,QSPR=="HTPBTK-InVitro")$RPE)
