...
stats.table <- makestatstable2(stats.table,
                ...
                chem.lists,
                sigfig=2)
write.csv(stats.table,file="tables/Table5-Level2-Cvt-RMSLEstats.txt",row.names=TRUE)
kable(stats.table)
...
stats.table <- makestatstable2(stats.table,
                ...
                chem.lists,
                sigfig=2)
write.csv(stats.table,file="tables/SupTable-Level2-Cvt-AFEstats.txt",row.names=TRUE)
kable(stats.table)
...
stats.table <- makestatstable2(stats.table,
                ...
                label="AFE",
                sigfig=2)
write.csv(stats.table,file="tables/Table6-Level2-Cvt-RMSLEAAFEAFEcomp.txt",row.names=TRUE)
kable(stats.table)
rmsle.stats.table <- stats.table
```
