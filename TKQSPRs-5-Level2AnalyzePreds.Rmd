...
write.table(stats.table,
          ...
          row.names=TRUE)
kable(stats.table)
max.rmsle.stats.table <- stats.table
```
...
write.table(stats.table,
            sep="\t",
            file="tables/SupTable-Level2-Cvt-earlylatestats.txt",row.names=TRUE)
kable(stats.table)
...
write.table(stats.table,
            sep="\t",
            file="tables/SupTable-Level2-AUCstats.txt",row.names=TRUE)
kable(stats.table)
...
write.table(stats.table,
           sep="\t",
           file="tables/SupTable-Level2-Cmaxstats.txt",row.names=TRUE)
kable(stats.table)
