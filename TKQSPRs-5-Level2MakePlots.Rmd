...
tiff(file=paste("figs/Fig6-Lev2_RMSEbyChem_all",output.prefix,".tiff",sep=""), 
...
print(FigLev2)
ggsave(paste("figs/Fig5-Lev2_Conc_scatter",output.prefix,".tiff",sep=""), width=6, height=6, dpi=300)
```
