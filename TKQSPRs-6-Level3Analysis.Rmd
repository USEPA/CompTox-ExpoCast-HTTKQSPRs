...
write.csv(level3stats.table,file="tables/Table-Level3-stats.txt",row.names=FALSE)
```
...
print(FigLev3a)
ggsave(paste("figs/FigLev3a_thalf_obsVpred_",output.prefix,".tiff",sep=""), width=6, height=8, dpi=300)
```
