...
level3tab.arnot1$QSPR <- "QSARINS-Chem"
...
level3tab[level3tab$QSPR %in% c("QSARINS-Chem", "IFS-QSAR"),"Vd.pred"] <- NA
```
...
FigLev3c <- ggplot(data=subset(level3tab,!(QSPR %in% c("IFS-QSAR","QSARINS-Chem")))) +
