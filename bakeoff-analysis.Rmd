...
# Add HTTK without in silico predicitons:
...
AUC.stats.table <- rbind(AUC.stats.table,this.row)
save(AUC.stats.table,file="AUC-stats.txt")
...
Cmax.stats.table <- rbind(Cmax.stats.table,this.row)
save(Cmax.stats.table,file="Cmax-stats.txt")
```
...
save(halflife.stats.table,file="halflife-stats.txt")
...
save(vd.stats.table,file="VD-stats.txt")
...
save(cl.stats.table,file="Cl-stats.txt")
```
