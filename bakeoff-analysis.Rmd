...
setwd("C:/Users/jwambaug/git/tkqsars/")
fits1comp <- read.csv("PK.fit.table.1comp.alpha.fix.csv")
fits1comp <- subset(fits1comp, is.finite(AIC) & AIC < 10^4)
fits2comp <- read.csv("PK.fit.table.2comp.new.alpha.fix.csv")
...
AUC.stats.table <- rbind(AUC.stats.table,this.row)
write.csv(AUC.stats.table,file="AUC-stats.txt")
...
Cmax.stats.table <- rbind(Cmax.stats.table,this.row)
write.csv(Cmax.stats.table,file="Cmax-stats.txt")
```
...
write.csv(halflife.stats.table,file="halflife-stats.txt")
...
write.csv(vd.stats.table,file="VD-stats.txt")
...
write.csv(cl.stats.table,file="Cl-stats.txt")
```
